...
const Backgrounds = () => {
  ...
  return (
    <Box sx={{ p: 3 }}>
      ...
      >
        <Typography variant="h4">Marcos</Typography>

        <Button
          variant="contained"
          startIcon={<AddIcon />}
          onClick={() => navigate("/admin/mantenimientos/marcos/nuevo")}
        >
          Nuevo Marco
        </Button>
      </Box>
                    ...
                    <TableCell align="right">
                      <Tooltip title="Editar">
                        <IconButton
                          color="primary"
                          onClick={() =>
                            navigate(`/admin/mantenimientos/marcos/${bg.uuid}`)
                          }
                        >
                          <EditIcon />
                        </IconButton>
